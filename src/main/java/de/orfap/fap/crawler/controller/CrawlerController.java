...
public class CrawlerController {
    ...
    public void crawlIntoBackend() throws Exception{
        ...
        crawler.getRoutes("http://transtats.bts.gov/DownLoad_Table.asp?Table_ID=311&Has_Group=3&Is_Zipped=0", 2015);
//        crawler.getFlights("http://transtats.bts.gov/DownLoad_Table.asp?Table_ID=236&Has_Group=3&Is_Zipped=0", 2015);
